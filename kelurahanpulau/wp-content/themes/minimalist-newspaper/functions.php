<?php 
add_action( 'wp_enqueue_scripts', 'minimalist_newspaper_enqueue_styles' );
function minimalist_newspaper_enqueue_styles() {
	wp_enqueue_style( 'minimalist-newspaper-style', get_template_directory_uri() . '/style.css' ); 
} 

function minimalist_newspaper_enqueue_assets() {
	// Include the file.
	...
	wp_enqueue_style(
		'poppins',
		wptt_get_webfont_url( 'https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,400;0,500;0,600;1,400&display=swap' ),
		array(),
		'1.0'
	);
}
add_action( 'wp_enqueue_scripts', 'minimalist_newspaper_enqueue_assets' );





function minimalist_newspaper_customize_register( $wp_customize ) {

	$wp_customize->add_section( 'navigation_settings', array(
		'title'      => __('Navigation Settings','minimalist-newspaper'),
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'navigation_background_color', array(
		'label'       => __( 'Background Color', 'minimalist-newspaper' ),
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'navigation_text_color', array(
		'label'       => __( 'Link Color', 'minimalist-newspaper' ),
		'section'     => 'navigation_settings',
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'navigation_border_color', array(
		'label'       => __( 'Border Color', 'minimalist-newspaper' ),
		'section'     => 'navigation_settings',
		'priority'   => 1,
		'settings'    => 'navigation_border_color',
		) ) );
}
add_action( 'customize_register', 'minimalist_newspaper_customize_register', 999 );




if(! function_exists('minimalist_newspaper_customizer_css_final_output' ) ):
	function minimalist_newspaper_customizer_css_final_output(){
		?>
	...
	<?php }
	add_action( 'wp_head', 'minimalist_newspaper_customizer_css_final_output' );
endif;